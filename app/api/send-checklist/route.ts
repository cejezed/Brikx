...
// Base URL met fallback voor productie
...
const checklistsDb = {
  'Financiële Routekaart': {
    ...
    downloadUrl: `${baseUrl}/downloads/Brikx_Checklist_Financien.pdf`,
  },
  'Meerwerk': {
    subject: '🗺️ Jouw Stappenplan voor een Succesvol Bouwproject',
    downloadUrl: `${baseUrl}/downloads/Brikx_Checklist_Meerwerk.pdf`,
  },
  'Algemene Bouw Checklist': {
    subject: '🗺️ Jouw Stappenplan voor een Succesvol Bouwproject Checklist',
    downloadUrl: `${baseUrl}/downloads/Brikx_Checklist_De_Droom_Vormgeven.pdf`,
  },
  'Locatie': {
    subject: 'Jouw Locatie Checklist',
    downloadUrl: `${baseUrl}/downloads/Brikx_Checklist_Locatie.pdf`,
  },
};
