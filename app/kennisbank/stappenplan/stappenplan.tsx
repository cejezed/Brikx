      ...
      <section className="pb-16 lg:pb-24">
        <div className="max-w-[1252px] mx-auto rounded-3xl p-8 lg:p-10 text-white bg-gradient-to-br from-[#082b3f] to-[#1c7d86]  shadow-[0_24px_60px_rgba(13,61,77,0.14)]">
          ...
          <div className="mt-6 flex flex-col sm:flex-row gap-3">
            <button type="button" onClick={() => handleOpenModal('Algemene Bouw Checklist')} className="inline-flex justify-center items-center rounded-full bg-white text-[#0a7266] font-semibold px-6 py-3 hover:opacity-90">Download de Gratis Checklist</button>
